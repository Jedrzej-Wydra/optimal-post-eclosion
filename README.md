...
## Short summary  
Developed R-based simulation models combining meteorological data, iterative algorithms, and visualization to optimize time-series parameter estimation.

## Technical summary  
Constructed computational models in R to process and transform daily temperature data, integrating cumulative degree-days and iterative functions to evaluate parameter sensitivity. Used ggplot2 and plotly to generate time-series heatmaps and PMI/PEI optimization charts. Applied algorithmic simulations and scenario testing to assess error propagation and model robustness.
